...
class ParametricFunctionWrapper : public NumericalMathFunctionImplementation
{
public:
  ...
  virtual ParametricFunctionWrapper * clone() const
  {
    return new ParametricFunctionWrapper(*this);
  }
